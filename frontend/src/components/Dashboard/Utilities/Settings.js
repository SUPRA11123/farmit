...
class Settings extends React.Component {
    ...
    handleKeyDown = (event) => {
        if (event.keyCode === 27) {
            ...
            if (!document.getElementById('confirmLogout').classList.contains('hidden')) {
                this.cancelLogout();
            } else if (!document.getElementById('confirmDelete').classList.contains('hidden')) {
                this.cancelDelete();
            }
            else if (!document.getElementById('changePassword').classList.contains('hidden')) {
                this.cancelChangePassword();
            } else if (!document.getElementById('tAndC').classList.contains('hidden')) {
                this.cancelTandC();
            }
